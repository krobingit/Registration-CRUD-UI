...
import { useUpdateUser } from "../hooks/register-hooks";
import "react-toastify/dist/ReactToastify.css";
import { ToastContainer, toast } from "react-toastify";
import { useHistory, useParams } from "react-router-dom";
import { useUser } from "../hooks/register-hooks";
...
function UpdateUser() {
  ...
  const ToastSuccess = () => {
    return toast.success("User Updation Successful", {
      position: "top-right",
      autoClose: 3500,
                ...
                <HStack>
                  ...
                  <FieldContainer>
                    ...
                    <ProfilePic>
                      ...
                      />
                      {values?.profile_img instanceof File ? (
                        <Image
                          ...
                          {({ field }) => {
                            return (
                              <FormControlLabel
                                ...
                                control={
                                  <Checkbox
                                    defaultChecked={userData?.locations?.includes(
                                      value
                                    )}
                                    value={value}
                                    sx={{
